...
%>
                          ...
                          <table width="100%"  border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" class="thin">
                              <tr align="center">
                                <td width="442" height="24" align="center" valign="middle"><div align="center" class="style10">新&nbsp;&nbsp;&nbsp;闻 &nbsp;&nbsp;&nbsp;标 &nbsp;&nbsp;&nbsp;题 </div></td>
                                <td width="128" height="24"><div align="center" class="style10">发布时间 </div></td>
                              </tr>
                              <%if Not(rsn.bof and rsn.eof) then
...
%>
                              <tr>
                                <td width="442" height="25" align="center" valign="middle"><div align="left" class="style10">
                                    <div align="left"><img src="../images/fav_add1.gif" width="15" height="15"><font class="style10" style="cursor:hand" onclick="MM_openBrWindow('news_detail.asp?news_id=<%=rsn("news_ID")%>','新闻','scrollbars=yes,resizable=yes,width=650,height=500')"><%=rsn("news_title")%></font></div>
                                </div></td>
                                <td height="25"><div align="center"></div>
                                  <div align="center" class="style10"><%=rsn("news_time")%></div></td>
                              </tr>
                              <%rsn.movenext
