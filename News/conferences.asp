...
.STYLE12 {color: #004080}
-->
</style>
</head>

<body>
<table width="620" height="550" border="0">
  <tr>
...
%>
                <table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" class="thin">
                  <tr align="center">
                    <td width="93" height="24" align="center" valign="middle"><div align="center" class="STYLE11"> 发布时间 </div></td>
                    <td width="416" height="24"><div align="center" class="STYLE11 STYLE12">会 &nbsp;&nbsp;&nbsp;议 &nbsp;&nbsp;&nbsp;标 &nbsp;&nbsp;&nbsp;题 </div></td>
                    <td width="36"><div align="center" class="style10">点击</div></td>
                  </tr>
...
%>
                  <tr>
                    <td width="93" height="25" align="center" valign="middle"><div align="left">
                        <div align="center" class=style11><%=rsn("conference_time")%></div>
                    </div></td>
                    <td height="25"><div align="left">
                        <div align="left" class="style11"><img src="../images/fav_add1.gif" width="15" height="15"><font class="style10" style="cursor:hand" onclick="MM_openBrWindow('conference_detail.asp?conference_id=<%=rsn("conference_ID")%>','新闻','scrollbars=yes,resizable=yes,width=650,height=500')"> <%=rsn("conference_title")%></font></div></td>
